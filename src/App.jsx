...
// Floating flower emojis for letter page background
const BG_FLOWERS = ['🌸', '🌷', '💐', '🌺', '🌹', '💗', '✨', '🌼']

// ─── Photo placeholders — replace src with your actual photo paths
// Example: src: '/photos/photo1.jpg'
// Shapes: 'tall' | 'square' | 'wide'  (controls aspect ratio)
// Tilt: CSS rotation in degrees (negative = left, positive = right)
const PHOTOS = [
  { id: 1, src: '/images/img1.jpg', caption: 'Us always 💗', shape: 'tall', tilt: '-3deg' },
  { id: 2, src: '/images/img2.jpg', caption: 'My favorite day ✨',   shape: 'square', tilt: '2deg'  },
  { id: 3, src: '/images/img3.jpg', caption: 'Hehe 🌸',              shape: 'wide',   tilt: '-1.5deg'},
  { id: 4, src: '/images/img4.jpg', caption: 'Miss this 💭',         shape: 'square', tilt: '3.5deg'},
  { id: 5, src: '/images/img5.jpg', caption: 'Sobrang saya ko dito', shape: 'tall',   tilt: '-2deg' },
  { id: 6, src: '/images/img6.jpg', caption: 'I love you 🌷',        shape: 'wide',   tilt: '1deg'  },
  { id: 7, src: '/images/img7.jpg', caption: 'Best memory 💫',        shape: 'square', tilt: '-3.5deg'},
  { id: 8, src: '/images/img8.jpg', caption: 'Forever ganito tayo',  shape: 'tall',   tilt: '2.5deg'},
]
...
// Generates floating flower emoji elements for letter bg
  ...
  return (
    <div className={`page page-letter${isActive ? ' active' : ''}`}>
      ...
      <div className="letter-wrap">
        <div className="letter-eyebrow">From my heart</div>
        ...
        <div className="letter-card">
          <div className="letter-text">
            <p>
              I know nasaktan kita, and I'm really sorry for what I did.
              I broke my promise, and I understand kung bakit ka na-disappoint.
              Aware ako from the start na uncomfortable ka, pero hindi ko
              nirespeto yun.
            </p>
            <p>
              I take full responsibility. Mali talaga ako.
              I regret hurting you, and I want to make things right.
            </p>
            <p>
              I'll prove through my actions that I can do better.
              You mean so much to me.
            </p>
          </div>

          <div className="letter-sig">
            <span className="sig-label">With all my love,</span>
            <span className="sig-name">Always yours 💗</span>
          </div>
        </div>
  ...
  return (
    <div className={`page page-gallery${isActive ? ' active' : ''}`}>
      <div className="gallery-header">
        <div className="gallery-eyebrow">Just for you</div>
        <h2 className="gallery-title">Us, In Every Moment 🌸</h2>
      </div>

      {/* 
        TO ADD REAL PHOTOS:
        1. Put your photos inside the /public/photos/ folder
           Example: /public/photos/photo1.jpg
        2. In the PHOTOS array at the top of this file,
           change  src: null
           to      src: '/photos/photo1.jpg'
        3. You can also change the caption and shape (tall/square/wide)
      */}
...
{showPrompt && (
  <div className="prompt-overlay">
    <div className="prompt-box">
      <h3>Please enter your favorite number 💗</h3>
      <input
        type="number"
